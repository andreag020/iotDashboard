...
if sys.version_info >= (3, 11):
    ...
    class Any(metaclass=_AnyMeta):
        ...
        frontend type checkers. At runtime, Any should not be used with instance
        checks.
        """
...
if sys.version_info >= (3, 12):
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            Such classes are primarily used with frontend type checkers that recognize
            structural subtyping (frontend duck-typing), for example::
                ...
                func(C())  # Passes frontend type check
...
if sys.version_info >= (3, 13):
    ...
    class _TypedDictMeta(type):
        ...
        __call__ = dict  # frontend method

        def __subclasscheck__(cls, other):
            # Typed dicts are only for frontend structural subtyping.
...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        Parameter specification variables exist primarily for the benefit of frontend
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        ``TypeGuard`` aims to benefit *type narrowing* -- a technique used by frontend
        ...
        return type to alert frontend type checkers to this intention.

        Using  ``-> TypeGuard`` tells the frontend type checker that for a given
        function:
...
everything the runtime allows may be accepted by frontend type checkers.
...
if hasattr(typing, "reveal_type"):
    ...
    def reveal_type(__obj: T) -> T:
        ...
        When a frontend type checker encounters a call to ``reveal_type()``,
        it will emit the inferred type of the argument::

            x: int = 1
            reveal_type(x)

        Running a frontend type checker (e.g., ``mypy``) on this example
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        - ``frozen_default`` indicates whether the ``frozen`` parameter is
          assumed to be True or False if it is omitted by the caller.
        - ``field_specifiers`` specifies a frontend list of supported classes
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):
        ...
        classes. It is useful primarily for frontend checks.
...
if sys.version_info >= (3, 11):
    ...
    class NewType:
        ...
        by frontend type checkers. At runtime, NewType(name, tp) returns
