...
from model.app_model import get_tuya_devices, create_user, add_device_to_user, \
...
def handle_connect():
    ...
    emit('updated_devices', devices_db)
...
def get_device_data():
    ...
    device_data = [{'id': device['id'], 'labels': ['January', 'February', 'March', 'April', 'May', 'June'],
                    'data': [65, 59, 80, 81, 56, 55]} for device in devices]
